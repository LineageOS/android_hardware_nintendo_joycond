...
class virt_ctlr {
  ...
  public:
    ...
    virtual bool
    contains_phys_ctlr(std::shared_ptr<phys_ctlr> const ctlr) const = 0;
    ...
    // Used to determine if this virtual controller should be removed from
    // paired controllers list
